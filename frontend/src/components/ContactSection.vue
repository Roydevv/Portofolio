  ...
  <footer id="kontak" class="py-20 bg-gray-800 dark:bg-gray-900 text-white transition-colors duration-300">
    <div class="container mx-auto px-6 text-center">
      ...
      <div class="flex justify-center space-x-6 mt-12 mb-8">
        <a href="https://github.com/Roydevv" target="_blank" class="text-gray-400 hover:text-white transition-colors duration-300">GitHub</a>
        <a href="https://wa.me/628811399788" target="_blank" class="text-gray-400 hover:text-white transition-colors duration-300">WhatsApp</a>
      </div>
      <p class="text-gray-500">&copy; {{ new Date().getFullYear() }} Roy Devgantara Purba. {{ T.footer_made_with }} Vue.js</p>
    </div>
  </footer>
</template>
